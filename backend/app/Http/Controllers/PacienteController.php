...
class PacienteController extends Controller
{
    ...
    {
        return $this->successResponse(PacienteResource::collection(Paciente::all()), 200);
    }

    public function show($id)
    {
        return $this->successResponse(PacienteResource::collection(Paciente::where('id', '=', $id)->get()), 200);
    }
